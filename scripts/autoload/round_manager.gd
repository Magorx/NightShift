...
# ── Tuning ──────────────────────────────────────────────────────────────
const BASE_BUILD_DURATION := 180.0  # seconds, round 1
const BUILD_DECAY_PER_ROUND := 15.0 # seconds shorter each round
const MIN_BUILD_DURATION := 60.0

const BASE_FIGHT_DURATION := 60.0   # seconds, round 1
const FIGHT_GROWTH_PER_ROUND := 10.0 # seconds longer each round
